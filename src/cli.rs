...
fn run_setup(force: bool) -> Result<()> {
    ...
    if claude_path.is_some() {
        println!("  Claude Code: memex-search skill");
    }
    ...
    let stale_paths: Vec<PathBuf> = vec![
        ...
        // Gen 3: instruction-improver (retired)
        home.join(".claude/skills/instruction-improver"),
        home.join(".codex/skills/instruction-improver"),
    ];
